lazy val root = (project in file(".")).
  settings(
    inThisBuild(List(
      ...
      scmInfo := Some(
        ScmInfo(
        browseUrl = url("https://github.com/DFDLSchemas/MagVar"),
        connection = "scm:git:https://github.com/DFDLSchemas/MagVar.git")
      ),
      homepage in ThisBuild := Some(url("https://github.com/DFDLSchemas/MagVar"))
    )),
    name := "dfdl-magvar",
